...
<table>
<tr>
<td align="center" width="180"><b>Mathematics</b><br/><sub>Combinatorics · Probability</sub></td>
<td align="center" width="180"><b>Physics</b><br/><sub>Applied · Computational</sub></td>
<td align="center" width="180"><b>Artificial Intelligence</b><br/><sub>ML · Neural Networks</sub></td>
<td align="center" width="180"><b>Renewable Energy</b><br/><sub>Solar · Systems Design</sub></td>
</tr>
</table>
...
**[MNIST Training](https://github.com/DangNhutNguyen/MNIST-TRAINING)**

Trained and optimized models for handwritten digit classification on the MNIST benchmark, exploring the relationship between architecture and generalization.

`Python` · `Computer Vision` · `Optimization`
...
**[PrompTEA](https://github.com/DangNhutNguyen/PrompTEA)**

Treats prompt engineering as a craft: systematic testing of instruction structures, feedback loops, and LLM behaviors to build genuinely effective AI-assisted learning workflows.

`LLMs` · `Prompt Engineering` · `Research Tools`
...
[penciltalk0910@gmail.com](mailto:penciltalk0910@gmail.com) · [Portfolio](https://dangnhutnguyen.github.io/) · [GitHub](https://github.com/DangNhutNguyen)

<br/>

*Open to research collaborations, mentorship, and conversations about mathematics, AI, and renewable energy.*
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=14,20,24&height=100&section=footer&animation=fadeIn" width="100%" />

<sub>Nguyễn Huỳnh Đăng Nhựt · Vietnam · 2026</sub>
